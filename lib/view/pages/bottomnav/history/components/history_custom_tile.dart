...
class HistoryCustomTile extends StatelessWidget {
  const HistoryCustomTile({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: EdgeInsets.symmetric(horizontal: SizeConfig.widthMultiplier*4,vertical: SizeConfig.heightMultiplier*2),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("${tr("Today")} 10:20 - 10:40",
